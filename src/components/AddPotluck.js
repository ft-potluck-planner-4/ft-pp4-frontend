        ...
        <FormGroup row>
          ...
          <Col sm={10}>
            <Input
              ...
              value={newPotluck.potluck_name}
              onChange={handleChange}
            />
          </Col>
        </FormGroup>
        <FormGroup row>
          <Label for="location_name" sm={2}>
            Name of Location
          </Label>
          <Col sm={10}>
            <Input
              ...
              value={newPotluck.location_name}
              onChange={handleChange}
            />
          </Col>
        </FormGroup>
        <FormGroup row>
          <Label for="location_address" sm={2}>
            Address
          </Label>
          <Col sm={10}>
            <Input
              ...
              value={newPotluck.location_address}
              onChange={handleChange}
            />
          </Col>
        </FormGroup>
        <FormGroup row>
          <Label for="location_city" sm={2}>
            City
          </Label>
          <Col sm={10}>
            <Input
              ...
              id="location_city"
              placeholder="city"
              value={newPotluck.location_city}
              onChange={handleChange}
            />
          </Col>
        </FormGroup>
        <FormGroup row>
          <Label for="location_state" sm={2}>
            State
          </Label>
          <Col sm={10}>
            <Input
              ...
              id="location_state"
              placeholder="state"
              value={newPotluck.location_state}
              onChange={handleChange}
            />
          </Col>
        </FormGroup>
        <FormGroup row>
          <Label for="location_zip" sm={2}>
            Zip Code
          </Label>
          <Col sm={10}>
            <Input
        ...
        <FormGroup row>
          ...
          <Col sm={10}>
            <Input
              ...
              id="duration"
              placeholder="3 Hours"
              value={newPotluck.duration}
              onChange={handleChange}
            />
          </Col>
        </FormGroup>
        <FormGroup row>
          <Label for="organizer" sm={2}>
            Organizer
          </Label>
          <Col sm={10}>
            <Input
